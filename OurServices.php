...
<head>
    <meta charset="UTF-8">
    <title>Public Help Welfare || Services</title><!-- mobile responsive meta -->
        ...
        <div class="section-title">
            ...
            <article class="item col-md-8 col-sm-12 col-xs-12">
                ...
                <div class="content">
                    ...
                    <div class="text center">
                        <a href="#"><h4 class="title">Animals</h4></a>
            ...
            <article class="item col-md-8 col-sm-12 col-xs-12">
                ...
                <div class="content">
                    ...
                    <div class="text center">
                        <a href="#"><h4 class="title">Medical Care</h4></a>
            ...
            <article class="item col-md-8 col-sm-12 col-xs-12">
                ...
                <div class="content">
                    ...
                    <div class="text center">
                        <a href="#"><h4 class="title">Education</h4></a>
