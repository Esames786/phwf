...
<div class="page-wraper">
                    ...
                    <div class="clearfix">
                        <div class="wt-topbar-left">
                            <ul class="list-unstyled e-p-bx pull-left">
                                <li><i class="fa fa-envelope"></i>info@luxarconstruction.ca</li>
            ...
            <div class="main-bar bg-white" style="background: black">
                <div class="container">
                    <div class="logo-header">
                        <a href="index.php">
                            <img src="images/luxar_logo2.png" style="height:100px;width: 200px;padding: 10px "  alt=""/>
                        </a>
                    </div>
                    <!-- NAV Toggle Button -->
    ...
    <div class="page-content">
                        ...
                        <div id="rev_slider_1014_1" class="rev_slider fullscreenbanner" style="display:none;"
                            ...
                            <ul>
                                ...
                                <li data-index="rs-1000" data-transition="slidingoverlayhorizontal"
                                    ...
                                    data-thumb="images/main-slider/slider1//slide1.jpg" data-rotate="0"
                                    ...
                                    <div class="tp-caption   tp-resizeme"
                                        ...
                                        <span class="text-uppercase" style="font-family:'Roboto' ;"><span
                                                class="text-primary">We Build </span> Your Dream</span>
                                    </div>
                                ...
                                <li data-index="rs-2000" data-transition="slidingoverlayhorizontal"
                                    data-slotamount="default" data-hideafterloop="0" data-hideslideonmobile="off"
                                    data-easein="default" data-easeout="default" data-masterspeed="default"
                                    data-thumb="images/main-slider/slider1//slide2.jpg" data-rotate="0"
                                    data-saveperformance="off" data-title="Slide" data-param1="" data-param2=""
                                    data-param3="" data-param4="" data-param5="" data-param6="" data-param7=""
                                    data-param8="" data-param9="" data-param10="" data-description="">
                                    ...
                                    <div class="tp-caption  tp-resizeme"
                                        ...
                                        color: rgba(255, 255, 255, 0.85);
                                        border-width:0px;">
                                        <span style="font-family:'Roboto';"><br><br> We bring our expertise to a broad range of sectors, including commercial office, residential, industrial, healthcare, retail, hospitality and mixed-use.
                                        </span>
                                    </div>
                                ...
                                <li data-index="rs-3000" data-transition="slidingoverlayhorizontal"
                                    data-slotamount="default" data-hideafterloop="0" data-hideslideonmobile="off"
                                    data-easein="default" data-easeout="default" data-masterspeed="default"
                                    data-thumb="images/main-slider/slider1//slide3.jpg" data-rotate="0"
                                    data-saveperformance="off" data-title="Slide" data-param1="" data-param2=""
                                    data-param3="" data-param4="" data-param5="" data-param6="" data-param7=""
                                    data-param8="" data-param9="" data-param10="" data-description="">
                                    ...
                                    <div class="tp-caption  tp-resizeme"
                                        ...
                                        color: rgba(255, 255, 255, 0.85);
                                        border-width:0px;">
                                        <span style="font-family:'Roboto';"><br><br>Through the use of subcontractors, suppliers and our professional teams, we provide the necessary labour, materials, tools, equipment, temporary utilities and facilities to complete construction of a project.</span>
                                    </div>
        ...
        <div class="section-full bg-white p-t80 p-b50 scale-bg-top scale-bg-bottom">
            <div class="container">
                ...
                <div class="section-head text-center">
                    ...
                    <p>With a strong presence in the Construction and Building industry, professional services is a
                        vital bridgehead into our growth markets. We continue to broaden and deepen our technical
                        expertise and provide end-to-end solutions including analysis, advice and planning. Our
                        professional services range from consultancy and planning to design and engineering of a
                        programme. We provide thorough programme, project and construction management services.</p>
                </div>
                <!-- TITLE END -->
                    ...
                    <div class="owl-carousel Home-services-carousel owl-btn-vertical-center">
                        ...
                        <div class="item">
                            <div class="wt-box bg-white">
                                ...
                                <div class="wt-info p-tb30">
                                    ...
                                    <p>We Design & Develop Malls with Reliable Products and sustainability power. </p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="item">
                            <div class="wt-box bg-white">
                                ...
                                <div class="wt-info p-tb30">
                                    <h4 class="wt-title m-t0 m-b5"><a href="javascript:void(0);">Hospital Building</a>
                                    </h4>

                                    <p>We Design and Develop Hospital to insure secure pillar of trust and
                                        reliability.</p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="item">
                            <div class="wt-box bg-white">
                                ...
                                <div class="wt-info p-tb30">
                                    ...
                                    <p>We believe in constructing a home of strong pillars with a quality and
                                        effectively. </p>
                                </div>
                            </div>
                        </div>
        ...
        <div class="section-full bg-gray p-t80 p-b120 bg-no-repeat bg-left-center"
             style="background-image:url(images/background/why-choose-pic-2.png);">
            <div class="container">
                <!-- TITLE START-->
                <div class="section-head text-center">
                    ...
                    <p>The mission of Laado is to build on our reputation for integrity, excellence,
                        experience, professionalism and leadership as the nation’s finest construction organization by
                        strict adherence to our core values</p>
                </div>
                <!-- TITLE END-->
                        ...
                        <div class="col-md-4 col-sm-6 animate_line">
                            <div class="wt-icon-box-wraper  p-a30 center bg-white m-a5">
                                ...
                                <div class="icon-content">
                                    ...
                                    <p>The underlying mission that guides everything Laado, Inc. does is to provide top quality service that is unsurpassed in our region.</p>
                                </div>
                            </div>
                        </div>
                        <!-- COLUMNS 2 -->
                        <div class="col-md-4 col-sm-6 animate_line">
                            <div class="wt-icon-box-wraper  p-a30 center bg-white m-a5">
                                ...
                                <div class="icon-content ">
                                    ...
                                    <p>Over many years of experience &amp; our industry savvy project teams allow us to be a valuable &amp; strategic partner in every project that we do.<br>&nbsp;</p>
                                </div>
                            </div>
                        </div>
                        <!-- COLUMNS 3 -->
                        <div class="col-md-4 col-sm-6 animate_line">
                            <div class="wt-icon-box-wraper  p-a30 center bg-white m-a5">
                                ...
                                <div class="icon-content">
                                    ...
                                    <p>Sate of the industry (top of the industry)(state of the art)software tools for accounting, estimating, project controls, scheduling, 3D visualization, field data collection, GPS.</p>
                                </div>
                            </div>
                        </div>
                        <!-- COLUMNS 4 -->
                        <div class="col-md-4 col-sm-6 animate_line">
                            <div class="wt-icon-box-wraper  p-a30 center bg-white m-a5">
                                ...
                                <div class="icon-content">
                                    ...
                                    <p>Commitment to safety from the top to the bottom of Blois Construction has garnered (earned) national awards, and more importantly, a culture where everyone is looking out for each other, rather than just a program.</p>
                                </div>
                            </div>
                        </div>
                        <!-- COLUMNS 5 -->
                        <div class="col-md-4 col-sm-6 animate_line">
                            <div class="wt-icon-box-wraper  p-a30 center bg-white m-a5">
                                ...
                                <div class="icon-content">
                                    ...
                                    <p>We hire the best people possible and provide them with continually developing management systems, technology, personal development and leadership to allow them to provide the best service possible to our customers.</p>
                                </div>
                            </div>
                        </div>
                        <!-- COLUMNS 6 -->
                        <div class="col-md-4 col-sm-6 animate_line">
                            <div class="wt-icon-box-wraper  p-a30 center bg-white m-a5">
                                ...
                                <div class="icon-content">
                                    ...
                                    <p>Our goal is to truly be a partner with everyone that we work with and pro-actively address challenges to the budget and schedule in a strategic and fair manner.<BR>&nbsp;</p>
                                </div>
                            </div>
                        </div>
        ...
        <div class="section-full bg-white p-tb80 scale-bg-top scale-bg-bottom">
            ...
            <div class="container">
                <div class="section-head text-center">
                    ...
                    <p> Laado is dedicated to providing and maintaining a safe and healthy work environment for all employees at work and at home. LC is committed to providing employees with equipment, training, and best practices to achieve our shared goal, ZERO injuries, ZERO incidents</p>
        ...
        <div class="section-full p-tb100 bg-gray">
            <div class="container">
                <div class="section-head text-center">
                    ...
                    <p>
                        The Laado vision enhances the internal culture, and maintains Laado reputation as a construction
                        leader, an employer of choice, a trustworthy and respected contractor and an active community
                        member. LC aspires to be the most respected builder
                    </p>
                </div>
            </div>
            <div class="container">
                        ...
                        <div class="about-types row">
                            <div class="col-md-6 col-sm-6 m-b30">
                                <div class="wt-icon-box-wraper bx-style-1 p-a30 center bg-white">
                                    <div class="icon-lg text-primary m-b20">
                                        <span class="icon-cell text-primary"><img src="images/icon/home.png"
                                                                                  alt=""></span>
                                    </div>
                                    <div class="icon-content">
                                        <h5 class="wt-tilte text-uppercase">Building</h5>

                                        <p>Experience in cast in place concrete structures including manholes, catch basins, junction, transition, inlet/outlet and related structures.&nbsp;</p>
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-6 col-sm-6 m-b30">
                                <div class="wt-icon-box-wraper bx-style-1 p-a30 center bg-white">
                                    <div class="icon-lg text-primary m-b20">
                                        <span class="icon-cell text-primary"><img src="images/icon/paint-brush.png"
                                                                                  alt=""></span>
                                    </div>
                                    <div class="icon-content">
                                        <h5 class="wt-tilte text-uppercase">Renovation</h5>

                                        <p>We Renovate  Complete construction of complicated pump station structural concrete, box culverts and trapezoidal channels.</p>
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-6 col-sm-6 m-b30">
                                <div class="wt-icon-box-wraper bx-style-1 p-a30 center bg-white">
                                    <div class="icon-lg text-primary  m-b20">
                                        <span class="icon-cell text-primary"><img src="images/icon/jackhammer.png"
                                                                                  alt=""></span>
                                    </div>
                                    <div class="icon-content">
                                        <h5 class="wt-tilte text-uppercase">Digging</h5>

                                        <p>We have high quality digging equipments like Skid-steer loaders are among the most versatile machines available in the construction industry. .</p>
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-6 col-sm-6 m-b30">
                                <div class="wt-icon-box-wraper bx-style-1 p-a30 center bg-white">
                                    <div class="icon-lg text-primary m-b20">
                                        <span class="icon-cell text-primary"><img src="images/icon/window.png"
                                                                                  alt=""></span>
                                    </div>
                                    <div class="icon-content">
                                        <h5 class="wt-tilte text-uppercase">interior</h5>
                                        Construction and detailing are vital skills for all. This accessible, up-to-date text explains the principles of sound construction for interiors designing.
                                        <p></p>
                                    </div>
                                </div>
                            </div>
                ...
                <div class="section-content">
                    <div class="row">
                        ...
                        <div class="col-md-4 col-sm-4  m-tb15">
                            <div class="wt-team-one bg-white">
                                <div class="wt-team-media">
                                    <a href="javascript:void(0);"><img src="images/our-team4/pic1.jpg" class="" alt=""></a>
                                </div>
                                <div class="wt-team-info text-center bg-white p-a10">
                                    <h4 class="wt-team-title"><a href="javascript:void(0);">Laado </a></h4>
                        ...
                        <div class="col-md-4 col-sm-4 m-tb15">
                            <div class="wt-team-one bg-white">
                                <div class="wt-team-media ">
                                    <a href="javascript:void(0);"><img src="images/our-team4/pic4.jpg"  alt=""></a>

                                </div>
                                <div class="wnt-team-info text-center bg-white p-a10">
                                    <h4 class="wt-team-title"><a href="javascript:void(0);">John</a></h4>
                        ...
                        <div class="col-md-4 col-sm-4  m-tb15">
                            <div class="wt-team-one  bg-white">
                                <div class="wt-team-media">
                                    <a href="javascript:void(0);"><img src="images/our-team4/pic2.jpg" alt=""></a>

                                </div>
                                <div class="wt-team-info text-center bg-white p-a10">
                                    <h4 class="wt-team-title"><a href="javascript:void(0);">Andrew</a></h4>
...
<div class="styleswitcher">
    ...
    <div class="styleswitcher-inner">
        ...
        <ul class="color-skins">
            <li><a class="theme-skin skin-1" href="index-4a39b.html?theme=css/skin/skin-1" title="default Theme"></a>
            </li>
            <li><a class="theme-skin skin-2" href="index-461e7.html?theme=css/skin/skin-2" title="pink Theme"></a></li>
            <li><a class="theme-skin skin-3" href="index-4cce5.html?theme=css/skin/skin-3" title="sky Theme"></a></li>
            <li><a class="theme-skin skin-4" href="index-413f7.html?theme=css/skin/skin-4" title="green Theme"></a></li>
            <li><a class="theme-skin skin-5" href="index-419a6.html?theme=css/skin/skin-5" title="red Theme"></a></li>
            <li><a class="theme-skin skin-6" href="index-4fe5c.html?theme=css/skin/skin-6" title="orange Theme"></a>
            </li>
            <li><a class="theme-skin skin-7" href="index-4ab47.html?theme=css/skin/skin-7" title="purple Theme"></a>
            </li>
            <li><a class="theme-skin skin-8" href="index-45f8d.html?theme=css/skin/skin-8" title="blue Theme"></a></li>
            <li><a class="theme-skin skin-9" href="index-45663.html?theme=css/skin/skin-9" title="gray Theme"></a></li>
            <li><a class="theme-skin skin-10" href="index-428ac.html?theme=css/skin/skin-10" title="brown Theme"></a>
            </li>
            <li><a class="theme-skin skin-11" href="index-426b8.html?theme=css/skin/skin-11" title="gray Theme"></a>
            </li>
            <li><a class="theme-skin skin-12" href="index-47f4c.html?theme=css/skin/skin-12" title="golden Theme"></a>
            </li>
        </ul>
