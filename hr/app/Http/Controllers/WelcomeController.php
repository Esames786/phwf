...
//                return redirect($verify_url);
    ...
    public function codeVerify(Request $request) {
        ...
        $user = User::where('code',$request->verified)->where('email',$email)->first();
        ...
        if(!empty($user)) {
            ...
            Session::flash('flash_message', 'User Not Active');
            return redirect()->back();
        }

        } else {
                Session::flash('flash_message', 'Invalid Email or Code');
            return redirect::back();
        }
    }
