                ...
                <div class="col-md-4 col-sm-6">
                    <div class="widget widget_about">
                        ...
                        <div class="logo-footer clearfix p-b15">
                            <a href="index-2.html"><img src="images/luxar_logo2.png" width="200" height="67"
                                                        alt=""/></a>
                        </div>
                        <p>“Building it Once and Building it Right” is a philosophy adopted by all employees at LC. LC's quality management program, lead under the QHSE Manager, has been developed and perfected to ensure a commitment to quality.
                        </p>
                    </div>
                </div>
                <!-- RESENT POST
                ...
                <div class="col-md-4 col-sm-6  p-tb20">
                    <div class="wt-icon-box-wraper left  bdr-1 bdr-gray-dark p-tb15 p-lr10 clearfix">
                        ...
                        <div class="icon-content">
                            ...
                            <p>Luxar construction
                                4388 Rue Saint-Denis #257
                                Montreal, QC H2J 2L1</p>
                        </div>
                    </div>
                </div>
                <div class="col-md-4 col-sm-6  p-tb20 ">
                ...
                <div class="col-md-4 col-sm-6 p-tb20">
                    <div class="wt-icon-box-wraper left  bdr-1 bdr-gray-dark p-tb15 p-lr10 clearfix">
                        ...
                        <div class="icon-content">
                            ...
                            <p class="m-b0">info@luxarconstruction.com</p>
        ...
        <div class="container p-t30">
            <div class="row">
                <div class="wt-footer-bot-left">
                        <span
                            class="copyrights-text">© <?PHP date_default_timezone_set("America/New_York"); ECHO  date("Y") ?> Your Company. All Rights Reserved. Designed By <a >Luxar Construction</a>.</span>
                </div>
