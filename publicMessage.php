        ...
        <div class="breadcumb-wrapper">
            <div class="container">
                ...
                <div class="pull-right">
                    <a class="get-qoute" href="#"><i class="fa fa-arrow-circle-right"></i>Public Message</a>
                </div>
            </div>
        </div>
        ...
        <section class="about sec-padd2 style-2">
            <div class="container">
                <div class="row">
                    ...
                    <div class="img-box">
                        <img src="images/event_img/public_img.jpg" style="height:60rem" alt="">
                        
                    </div>
                        <div class="content">
                        <div class="section-title2">
                        <h3>A Public Message</h3>
</div>
<br>
                            <div class="text">
